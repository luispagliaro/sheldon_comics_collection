...
To see the web live, go to: www.matvey.com.ar/comics/index.html (to use the social networks functionality it is necessary to go to this page since APIs doen't work in local).
